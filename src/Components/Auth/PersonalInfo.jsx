...
function PersonalInfo() {
  ...
  const personalInfoFetch = async () => {
    try {
      const response = await axios.get('https://rbl.digiindiasolutions.com/v1/getPersonalInfo');
  ...
  const handledelete = async (_id) => {
    ...
    try {
      const response = await axios.delete(`https://rbl.digiindiasolutions.com/v1/deletePersonalInfo/${_id}`);
